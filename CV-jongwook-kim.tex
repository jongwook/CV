...
\begin{document}
	...
	\begin{cventries}
		...
		\cvsoftware{https://github.com/jongwook/vbap}{VBAP}{An iOS application that implements vector base amplitude panning (VBAP) using the accelerometer.}
	...
	\begin{cventries}
		...
		\cvskill{Music}{Played the oboe in many orchestras and the piano in bands. Also have played the viola and taepyeongso.}%
